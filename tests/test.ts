...
const result = generator
  ...
  .section('Config Objects', {
    ...
    section.addObject({
      ...
      objBuilder
        ...
        .nestedObject('production', (nestedBuilder) => {
          nestedBuilder
  ...
  .section('Logic Statements and Loops', {
    ...
    section.addIf((ifBuilder) => {
      ifBuilder
        ...
        .then((block) => {
          ...
          block.addStatement('console.log(`Processed ${data.items.length - skipCount} items, skipped ${skipCount} items`)');
        })
        .else((block) => {
